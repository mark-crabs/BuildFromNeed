use crate::{
    ...
    models::{
        ProblemFavourite as ProblemFavouriteModel, SolutionFavourite as SolutionFavouriteModel,
    },
};
...
use problems::models::{ProblemLike as ProblemLikeModel, SolutionLike as SolutionLikeModel};
use utils::{
    config::AppState,
    db::schema::{
